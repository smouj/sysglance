...
The audit and measured baselines live in [`docs/COMMERCIAL_BASELINE.md`](docs/COMMERCIAL_BASELINE.md) and [`docs/PERFORMANCE_BASELINE.md`](docs/PERFORMANCE_BASELINE.md). The final evidence report is [`docs/FINAL_AUDIT.md`](docs/FINAL_AUDIT.md). The metric, alert, release and optional Store/MSIX boundaries are documented in [`docs/METRIC_ENGINE.md`](docs/METRIC_ENGINE.md), [`docs/ALERTS.md`](docs/ALERTS.md), [`docs/RELEASE.md`](docs/RELEASE.md) and [`docs/MSIX.md`](docs/MSIX.md).
