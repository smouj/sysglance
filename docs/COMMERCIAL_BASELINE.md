...
| `npm run verify` | PASS; 35 syntax, 36 config, 28 shell, 34 extended shell, 17 history/health/alert, 9 metric, 7 diagnostics, 7 journal, 4 transaction, 5 profile-shell, 14 profile, 8 process, 9 display, 6 install, 16 desktop-action, 4 logging and unique IPC checks. |
