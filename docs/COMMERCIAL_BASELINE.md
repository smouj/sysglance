...
| `npm run verify` | PASS; 36 syntax, 36 config, 28 shell, 34 extended shell, 17 history/health/alert, 10 metric, 7 diagnostics, 7 journal, 4 transaction, 5 profile-shell, 14 profile, 8 process, 9 display, 6 install, 18 desktop-action, 4 logging, 4 privacy and unique IPC checks. |
...
| `npm run build:win` | PASS on electron-builder 26.15.3; NSIS installer, blockmap, unpacked app and native helper were produced. Latest local artifact: 111,918,418 bytes, SHA-256 `5DA8D1BE7774A292F42411BBD959CB1DEE3583A256AEF50C14CFE8F9E8B22415`. |
