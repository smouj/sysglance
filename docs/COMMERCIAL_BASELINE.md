...
| `npm run verify` | PASS; 36 syntax, 36 config, 28 shell, 34 extended shell, 17 history/health/alert, 10 metric, 7 diagnostics, 7 journal, 4 transaction, 5 profile-shell, 14 profile, 8 process, 9 display, 6 install, 17 desktop-action, 4 logging, 4 privacy and unique IPC checks. |
...
| `npm run build:win` | PASS on electron-builder 26.15.3; NSIS installer, blockmap, unpacked app and native helper were produced. Latest local artifact: 111,918,157 bytes, SHA-256 `C64478FCCDA65FF9EB970BC308F58FDB1121074D3ABB63B82FE366485682D366`. |
