...
check('renderer folder customization is restricted to offered home folders', shellIpc.includes('resolveSpecialFolderPath') && shellIpc.includes('folder path is not an offered home folder') && shellIpc.includes('taskbar.listSpecialFolders()'));
