...
check('renderer exposes selected display topology summary', renderer.includes('display-summary') && renderer.includes('refreshRate') && renderer.includes('rotation') && renderer.includes('HDR unavailable') && main.includes('hdr:'));
